...
var modal = function modal(source) {
  ...
  if (existingModal !== null) {
    ...
    return body.insertAdjacentHTML('beforeend', '<div id="creditkey-modal" style="' + _modal.modal_main + '"><div style="' + _modal.modal_background + '"></div><div id="modal-card" style="' + (width <= 479 ? _modal.modal_card_mobile : _modal.modal_card) + '">' + iframe + '</div></div>');
  }
};
