...
var frame = function frame(url, pointer) {
  ...
  var iframe = "<div className=\"iframe-container\"><iframe allowtransparency=\"true\" scrolling=\"no\" id=\"creditkey-pdp-iframe\" title=\"Credit Key\" frameBorder=\"0\" style=\"" + style + "\" src=\"" + url + "\"></iframe></div>";
  return iframe;
};
exports.frame = frame;
