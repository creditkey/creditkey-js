...
var Client = /*#__PURE__*/function () {
  ...
  _proto.get_pdp_display = function get_pdp_display(charges, desktop, mobile) {
    ...
    var url = (0, _platform.pdpHost)(_platform.marketingUI, this.platform) + '/pdp/' + this.key + '/' + desktop + '/' + mobile + '/' + [charges.data.total, charges.data.shipping, charges.data.tax, charges.data.discount_amount, charges.data.grand_total].join(',');
