...
var Client = /*#__PURE__*/function () {
  ...
  _proto.get_cart_display = function get_cart_display(charges) {
    var url = (0, _platform.pdpHost)(_platform.marketingUI, this.platform) + '/cart-promo/' + this.key + '/' + [charges.data.total, charges.data.shipping, charges.data.tax, charges.data.discount_amount, charges.data.grand_total].join(',');
    return (0, _modalPdpBanner["default"])(url);
  };
