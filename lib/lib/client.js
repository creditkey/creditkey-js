...
var Client = /*#__PURE__*/function () {
  ...
  _proto.enhanced_pdp_modal = function enhanced_pdp_modal(charges) {
    ...
    var url = (0, _platform.pdpHost)(_platform.ui, this.platform) + '/pdp/' + this.key + '/' + [charges.data.total, charges.data.shipping, charges.data.tax, charges.data.grand_total].join(',');
