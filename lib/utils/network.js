...
var Network = function Network(platform, resource) {
  ...
  return {
    ...
    post: function post(path, body) {
      ...
      return (0, _request2.default)(buildURL(path), (0, _lodash2.default)(options, defaultOptions, {
        method: 'POST',
    ...
    get: function get(path) {
      ...
      return (0, _request2.default)(buildURL(path), (0, _lodash2.default)(options, defaultOptions, { method: 'GET' }));
    },
    ...
    delete: function _delete(path) {
      ...
      return (0, _request2.default)(buildURL(path), (0, _lodash2.default)(options, defaultOptions, { method: 'DELETE' }));
    },
