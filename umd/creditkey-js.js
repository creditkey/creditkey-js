/*!
 * creditkey-js v1.0.20 - https://www.creditkey.com
 * MIT Licensed
 */
...
var Network = function Network(platform, resource) {
  ...
  return {
    ...
    post: function post(path, body) {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_0__request__["a" /* default */])(buildURL(path), Object(__WEBPACK_IMPORTED_MODULE_2_lodash__["assign"])(options, defaultOptions, {
        method: 'POST',
    ...
    get: function get(path) {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_0__request__["a" /* default */])(buildURL(path), Object(__WEBPACK_IMPORTED_MODULE_2_lodash__["assign"])(options, defaultOptions, { method: 'GET' }));
    },
    ...
    delete: function _delete(path) {
      ...
      return Object(__WEBPACK_IMPORTED_MODULE_0__request__["a" /* default */])(buildURL(path), Object(__WEBPACK_IMPORTED_MODULE_2_lodash__["assign"])(options, defaultOptions, { method: 'DELETE' }));
    },

    ping: function ping() {
      return Object(__WEBPACK_IMPORTED_MODULE_0__request__["a" /* default */])(buildURL(), { method: 'GET' });
    }
  };
};
